  ...
  return (
    <div className="min-h-screen pt-24 pb-20 bg-[#F7FAF7]">
      ...
      <div className="relative h-64 mb-12 overflow-hidden border-b border-[#e8f5e9]">
        <Image src="https://images.unsplash.com/photo-1593691512429-cf7bc300da82?w=1400&q=80" alt="New arrivals" fill className="object-cover" />
        <div className="absolute inset-0 bg-gradient-to-r from-[#1b4332]/95 via-[#2d6a4f]/80 to-transparent" />
